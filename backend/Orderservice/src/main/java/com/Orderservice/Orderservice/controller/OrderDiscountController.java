...
public class OrderDiscountController {
    ...
    public ResponseEntity<?> calculateOrderWithDiscount(@PathVariable Long orderId,
        ...
        try {
            ...
            OrderService.OrderCalculationResult calculation = 
                    orderService.calculateOrderWithDiscount(order.getOrderItems(), discountCode, userId);
            ...
            return ResponseEntity.ok(DiscountCalculationResponse.failure("Error calculating discount: " + e.getMessage()));
        }
    }
