# Google Cloud Run Deployment Commands (PowerShell)
...
gcloud run deploy $SERVICE_NAME `
    ...
    --set-env-vars "USER_SERVICE_URL=https://user-service-337812374841.us-central1.run.app" `
    --set-env-vars "PRODUCT_SERVICE_URL=https://product-service-337812374841.us-central1.run.app" `
    --set-env-vars "ORDER_SERVICE_URL=https://order-service-337812374841.us-central1.run.app" `
