...
INSERT INTO features_supplier_daily (
  supplier_id, feature_date, otif_30d, late_rate_30d, spend_30d,
  open_po_count, median_lead_time_90d, lead_time_iqr_90d,
  defect_rate_180d, dispute_rate_180d, price_index_30d, created_at
)
...
INSERT INTO supplier_scores_daily (
  supplier_id, score_date, on_time_rate_30d, in_full_rate_30d,
  avg_late_days_30d, median_lead_time_90d, lead_time_iqr_90d,
  price_index_30d, created_at
)
...
INSERT INTO features_po_at_creation (
  ...
  expected_lead_time_days, supplier_otif_90d, supplier_lead_time_var,
