        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {filteredCustomers.length !== customers.length ? `${filteredCustomers.length} filtered` : 'All customers'}
            </p>
          </CardContent>
        </Card>
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {customers.length === 0 ? 'No customers have signed up yet.' : 'Try adjusting your filters.'}
              </p>
            </div>
          ) : (
                ...
                <tbody>
                  {filteredCustomers.map((customer) => (
                    <tr key={customer.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">{getStatusBadge(customer.accountStatus)}</td>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4 text-gray-600">{formatDate(customer.createdAt)}</td>
                      <td className="py-3 px-4">
                        <Button
                          variant="outline"
                          size="sm"
