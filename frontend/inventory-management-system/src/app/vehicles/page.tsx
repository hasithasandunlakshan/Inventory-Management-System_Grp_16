...
import { Car, Truck, Plus, Eye, Search, AlertTriangle, Wrench } from 'lucide-react';
import { driverService, Vehicle, VehicleRegistrationRequest } from '@/lib/services/driverService';
...
export default function VehiclesPage() {
  ...
  const [registrationForm, setRegistrationForm] = useState<VehicleRegistrationRequest>({
    vehicleNumber: '',
    vehicleType: 'CAR',
    capacity: 0,
    make: '',
  ...
  const loadVehicles = async () => {
    try {
      setLoading(true);
      const [allVehiclesResponse, availableVehiclesResponse] = await Promise.all([
    ...
    <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: any) => setRegistrationForm({...registrationForm, vehicleType: value})}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRegistrationForm({...registrationForm, capacity: Number(e.target.value)})}
                      required
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRegistrationForm({...registrationForm, year: Number(e.target.value)})}
                      min="1900"
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRegistrationForm({...registrationForm, lastMaintenance: e.target.value})}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRegistrationForm({...registrationForm, nextMaintenance: e.target.value})}
                    />
                  </div>
                </div>
      ...
      <Tabs defaultValue="all" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="assigned">Assigned ({vehicles.filter(v => v.status === 'ASSIGNED').length})</TabsTrigger>
            ...
            <CardContent>
              {filteredVehicles.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  {canManageVehicles && (
                    <p className="text-sm text-gray-400">Click "Add Vehicle" to add your first vehicle</p>
                  )}
                </div>
              ) : (
                    ...
                    <div key={vehicle.vehicleId} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            {vehicle.vehicleType} | Capacity: {vehicle.capacity}kg
                          </p>
          ...
          <Card>
            ...
            <CardContent>
              {vehicles.filter(v => v.status === 'ASSIGNED').length === 0 ? (
                ...
                <div className="space-y-4">
                  {vehicles.filter(v => v.status === 'ASSIGNED').map((vehicle) => (
                    <div key={vehicle.vehicleId} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          {vehicle.nextMaintenance && (
                            <p className="text-sm text-gray-500">Next: {vehicle.nextMaintenance}</p>
                          )}
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
