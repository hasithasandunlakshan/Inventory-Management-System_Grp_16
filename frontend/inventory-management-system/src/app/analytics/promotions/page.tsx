...
const dummyPromotions: Promotion[] = [
  {
    ...
    description:
      'Special discount on premium rice varieties for New Year celebrations',
    type: 'Percentage',
    value: 15,
    status: 'Active',
...
export default function PromotionsPage() {
  ...
  const filteredPromotions = useMemo(() => {
    return dummyPromotions.filter(promotion => {
      ...
      const matchesType =
        selectedType === 'All' || promotion.type === selectedType;
      const matchesSearch =
        searchTerm === '' ||
  ...
  const stats = useMemo(() => {
    ...
    const scheduled = dummyPromotions.filter(
      p => p.status === 'Scheduled'
    ).length;
    const totalSavings = dummyPromotions.reduce(
      (sum, p) => sum + p.totalSavings,
      0
    );
    const avgClickThrough =
      dummyPromotions.reduce((sum, p) => sum + p.clickThroughRate, 0) /
          ...
          <div className='flex justify-between items-center py-8'>
            <div>
              ...
              <p className='text-muted-foreground mt-2'>
                Manage marketing campaigns and promotional offers
              </p>
            </div>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mb-6'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {stats.avgClickThrough.toFixed(1)}%
              </div>
            </CardContent>
          </Card>
          <Card>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setSelectedStatus(v as PromotionStatus | 'All')
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  value={selectedType}
                  onValueChange={v =>
                    setSelectedType(v as PromotionType | 'All')
                  }
                >
                  <SelectTrigger>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8'>
          {filteredPromotions.map(promotion => {
            ...
            const typeDisplay = getPromotionTypeDisplay(
              promotion.type,
              promotion.value
            );
              ...
              >
                <CardHeader>
                  <CardTitle className='flex items-center justify-between'>
                    ...
                    <span
                      className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border bg-muted`}
                    >
                      {statusStyle.icon}
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                      <div className='text-center p-3 bg-muted rounded-lg'>
                        <div className='text-lg font-bold'>
                          LKR {promotion.totalSavings.toLocaleString()}
                        </div>
