...
const Icons = {
  ...
  ShoppingCart: () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 8M7 13l2.5 8m10-8v8a2 2 0 01-2 2H9a2 2 0 01-2-2v-8m10 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v4" />
    </svg>
  ),
  Truck: () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
type ReportType = "inventory" | "sales" | "orders" | "logistics" | "financial" | "supplier";
...
const salesData: SalesReport[] = [
  { period: "Jan 2025", revenue: 1250000, orders: 485, averageOrderValue: 2577, topProducts: ["Rice", "Tea", "Sugar"], growth: 12.5 },
  { period: "Feb 2025", revenue: 1380000, orders: 520, averageOrderValue: 2653, topProducts: ["Oil", "Rice", "Spices"], growth: 10.4 },
  { period: "Mar 2025", revenue: 1420000, orders: 545, averageOrderValue: 2605, topProducts: ["Tea", "Rice", "Oil"], growth: 2.9 }
];

const logisticsData: LogisticsReport[] = [
  { deliveryDate: "2025-01-15", ordersDelivered: 45, averageDeliveryTime: 2.5, deliverySuccess: 95.5, fuelCost: 8500, driverEfficiency: 89 },
  { deliveryDate: "2025-01-20", ordersDelivered: 52, averageDeliveryTime: 2.8, deliverySuccess: 92.3, fuelCost: 9200, driverEfficiency: 85 },
  { deliveryDate: "2025-01-25", ordersDelivered: 48, averageDeliveryTime: 2.2, deliverySuccess: 97.9, fuelCost: 7800, driverEfficiency: 92 }
];
...
export default function ReportsPage() {
  ...
  const reportTypes = [
    { id: "inventory", name: "Inventory", icon: Icons.Package, color: "bg-blue-500" },
    { id: "sales", name: "Sales", icon: Icons.TrendingUp, color: "bg-green-500" },
    { id: "orders", name: "Orders", icon: Icons.ShoppingCart, color: "bg-purple-500" },
    { id: "logistics", name: "Logistics", icon: Icons.Truck, color: "bg-orange-500" },
    { id: "financial", name: "Financial", icon: Icons.CurrencyDollar, color: "bg-red-500" },
    { id: "supplier", name: "Suppliers", icon: Icons.Building, color: "bg-indigo-500" }
  ];
                            ...
                            <tr key={item.productId} className="hover:bg-muted/30">
                              ...
                              <td className="px-6 py-4">
                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getInventoryStatusColor(item.status)}`}>
                                  {item.status === "In Stock" && <Icons.CheckCircle />}
                                  {item.status === "Low Stock" && <Icons.Warning />}
                                  {item.status === "Out of Stock" && <Icons.XCircle />}
                                  {item.status === "Overstocked" && <Icons.TrendingUp />}
