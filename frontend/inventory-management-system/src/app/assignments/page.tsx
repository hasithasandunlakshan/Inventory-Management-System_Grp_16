...
import { Route, Plus, Eye, Search, UserCheck, Car, Calendar } from 'lucide-react';
import { 
  driverService, 
                  ...
                  <div key={assignment.assignmentId} className="p-4 border rounded-lg">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">Driver ID: {assignment.driverId}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Car className="h-4 w-4 text-gray-400" />
                        <span className="text-sm">Vehicle ID: {assignment.vehicleId}</span>
                      </div>
                      <div className="flex items-center space-x-2">
