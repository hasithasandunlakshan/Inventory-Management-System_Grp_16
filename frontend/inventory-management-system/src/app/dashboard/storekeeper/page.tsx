...
import { Package, Truck, AlertTriangle, CheckCircle, BarChart3, Users } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold tracking-tight">Storekeeper Dashboard</h1>
