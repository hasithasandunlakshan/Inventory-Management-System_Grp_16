...
function ProfileContent() {
  ...
  const permissionItems = [
    ...
    { key: 'canManageCategories', label: 'Manage Categories', icon: CheckCircle },
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Your account details and permissions</p>
        </div>
      </div>
              ...
              {user?.formattedAddress && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{user.formattedAddress}</p>
                  </div>
                </div>
              )}
              {user?.createdAt && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Features and sections you can access based on your role</CardDescription>
        </CardHeader>
        <CardContent>
