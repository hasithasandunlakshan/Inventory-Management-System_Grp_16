...
export default function DocumentIntelligencePage() {
  ...
  const processDocument = async () => {
    ...
    try {
      const result =
        await DocumentIntelligenceService.analyzeDocument(selectedFile);
      ...
      <div className='flex items-center space-x-2'>
        ...
        <div>
          ...
          <p className='text-gray-600'>
            Extract text, tables, and structured data from documents using Azure
            AI
          </p>
        </div>
      </div>
          ...
          <div className='grid gap-6 lg:grid-cols-2'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload images or PDFs to extract text, tables, and key-value
                  pairs
                </CardDescription>
              </CardHeader>
          ...
          <div className='grid grid-cols-1 gap-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Translate entire documents using Azure Document Translation
                  service
                </CardDescription>
              </CardHeader>
              <CardContent>
