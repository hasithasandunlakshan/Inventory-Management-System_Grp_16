...
export const revenueService = {
  getTodayRevenue: async (dateFrom?: string, dateTo?: string): Promise<TodayRevenueResponse> => {
    try {
      const headers = {
  ...
  getMonthlyRevenue: async (dateFrom?: string, dateTo?: string): Promise<MonthlyRevenueResponse> => {
    try {
  ...
  getStripeStats: async (dateFrom?: string, dateTo?: string): Promise<StripeStatsResponse> => {
    try {
