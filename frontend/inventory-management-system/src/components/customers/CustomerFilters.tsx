...
export default function CustomerFilters({ onFiltersChange, onRefresh, isLoading }: CustomerFiltersProps) {
    ...
    <Card>
      <CardContent className="p-4">
        ...
        <div className="mt-4 pt-4 border-t">
          <Label className="text-sm text-gray-600 mb-2 block">Quick Filters:</Label>
