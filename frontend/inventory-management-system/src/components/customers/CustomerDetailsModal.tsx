...
import { User, Calendar, Mail, Phone, MapPin, CheckCircle, X, Eye } from "lucide-react";
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          {(customer.formattedAddress || (customer.latitude && customer.longitude)) && (
            <Card>
              <CardContent className="p-4">
                  ...
                  {customer.formattedAddress && (
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{customer.formattedAddress}</p>
                      </div>
                    </div>
                  )}
