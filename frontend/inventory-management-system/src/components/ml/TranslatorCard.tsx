...
export default function TranslatorCard({ onTranslationComplete }: TranslatorCardProps) {
      ...
      <CardContent className="space-y-4">
        ...
        {translation && (
          <div className="space-y-3 p-4 bg-green-50 rounded-lg border">
            ...
            <div className="space-y-2">
              <div>
                <label className="text-xs font-medium text-gray-600">Original ({translation.source_language})</label>
              ...
              <div>
                <label className="text-xs font-medium text-gray-600">Translated ({translation.target_language})</label>
