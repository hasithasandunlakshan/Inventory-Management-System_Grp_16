...
import { UserDropdownInfo, DriverRegistrationForm, FormErrors, DriverRegistrationRequest } from '@/types/driver';
import { 
  validateDriverForm, 
...
export default function DriverRegistrationModal({ 
  ...
  const [form, setForm] = useState<DriverRegistrationForm>(getInitialDriverForm());
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => handleUserSelectionChange(value, setSelectedUserId, errors, setErrors)}
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleFormFieldChange('licenseNumber', e.target.value, form, setForm, errors, setErrors)}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleFormFieldChange('licenseClass', e.target.value, form, setForm, errors, setErrors)}
                className={errors.licenseClass ? 'border-red-500' : ''}
                placeholder="e.g., B, C, AB"
                maxLength={2}
              />
              {errors.licenseClass && (
                <p className="text-sm text-red-500 mt-1">{errors.licenseClass}</p>
              )}
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleFormFieldChange('licenseExpiry', e.target.value, form, setForm, errors, setErrors)}
                className={errors.licenseExpiry ? 'border-red-500' : ''}
                min={getMinLicenseExpiryDate()}
              />
              {errors.licenseExpiry && (
                <p className="text-sm text-red-500 mt-1">{errors.licenseExpiry}</p>
              )}
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleFormFieldChange('emergencyContact', e.target.value, form, setForm, errors, setErrors)}
